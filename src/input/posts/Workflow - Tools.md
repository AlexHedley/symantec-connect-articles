...
These are explained in the User Guides
  
- Symantec™ Workflow 7.5 User Guide [[DOC5941](https://support.symantec.com/en_US/article.DOC5941.html)]
- Symantec™ Workflow 7.6 User Guide [[DOC8047](https://support.symantec.com/en_US/article.DOC8047.html)]
- Symantec™ Workflow 8.0 User Guide [[DOC8698](https://support.symantec.com/en_US/article.DOC8698.html)]
- Symantec™ Workflow 8.1 User Guide [[DOC9625](https://support.symantec.com/en_US/article.DOC9625.html)]

You can get to the applications in a number of ways, one is from the Start Menu.
  
Start &gt; Programs &gt; Symantec &gt; Workflow Designer &gt; Tools
  
Below are links to a series of Articles explaining more about each of the tools in further detail.
